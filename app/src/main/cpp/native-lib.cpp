...
extern "C" {
void Java_com_example_myapplication_views_CameraPreviewView_InitTemplateImage(
...
jboolean Java_com_example_myapplication_views_CameraPreviewView_ImageProcessing(
